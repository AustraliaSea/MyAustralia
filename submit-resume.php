                ...
                <div class="container clearfix">
                    ...
                    <div class="extra-nav">
                        <div class="extra-cell">
                            <a href="register.php" class="site-button"><i class="fa fa-user"></i> Sign Up</a>
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
                        <ul class="nav navbar-nav">
							<li class="active">
								<a href="#">Home <i class="dez-page"></i></a>
								<!--	<ul class="sub-menu">
							...
							<li>
								...
								<ul class="sub-menu">
									<li><a href="browse-job.php" class="dez-page">Browse Job</a></li>
									<li><a href="companies.php" class="dez-page">companies</a></li>
									<li><a href="job-detail.php" class="dez-page">Job Detail</a></li>
								</ul>
							</li>
							<li>
								<a href="#">For Employers <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									<li><a href="browse-candidates.php" class="dez-page">Browse Candidates</a></li>
									<li><a href="submit-resume.php" class="dez-page">Submit Resume</a></li>
								</ul>
							</li>
							<li>
